...
class CreateWipItfSerieHistory extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (!Schema::connection('sqlebs')->hasTable('XXE_WIP_ITF_SERIE_HISTORY')) 
        {
            Schema::connection('sqlebs')->create('XXE_WIP_ITF_SERIE_HISTORY', function (Blueprint $table) {
    ...
    {
        Schema::connection('sqlebs')->dropIfExists('XXE_WIP_ITF_SERIE_HISTORY');
    }
}
